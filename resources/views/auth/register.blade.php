                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.users.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cell_phone_number" type="number" class="form-control" name="cell_phone_number">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="identification_card" type="number" class="form-control" name="identification_card" required min="11">
                            </div>
